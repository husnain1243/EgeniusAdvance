...
function showMenuItems(){
	...
	$(".sideBarUl li").each(function(i,e) {
		...
		setTimeout(function(){
			...
			playEventSound('https://raw.githubusercontent.com/ystanwar/Melisandre/master/static/sounds/multimedia_rollover_048.mp3',$(".soundCont"));
		},200*i);        
    });
	showfooterGraph();
	setTimeout(function(){
		showGalCont();
		playEventSound('https://raw.githubusercontent.com/ystanwar/Melisandre/master/static/sounds/robot_movement_6.mp3',$(".soundCont"));
...
function hideWelcomeRings(){
	playEventSound('https://raw.githubusercontent.com/ystanwar/Melisandre/master/static/sounds/servo_motor.mp3',$(".soundCont"));
...
function animateBGRings(){
	setTimeout(function(){
		...
		animateRing3();
		playEventSound('https://raw.githubusercontent.com/ystanwar/Melisandre/master/static/sounds/slanesh__bip.mp3',$(".soundCont1"));
	},1000);
	setTimeout(function(){
...
function animateSemText(){
	playEventSound('https://raw.githubusercontent.com/ystanwar/Melisandre/master/static/sounds/osd-text-10.mp3',$(".soundCont1"));
	$('.semText').airport(['Egenius-Platform']);
	setTimeout(function(){
...
function animateJuryText(){
	$('.juryText').airport(['Husnain@Egenius.co']);
	setTimeout(function(){
		animateCursor();
	},2000)			
}
...
function animateCursor(){
	setTimeout(function(){
		var newHTML = ($('.juryText').html()=='melisandre')?'Bitcoin_':'Husnain@Egenius.co';
...
function jarvisRecog(){
	playEventSound('https://raw.githubusercontent.com/ystanwar/Melisandre/master/static/sounds/multimedia_rollover_046.mp3',$(".soundCont"));
	$(".lockIcon").css({'background-image':'https://raw.githubusercontent.com/ystanwar/Melisandre/master/url(static/images/lock1.png)'});	
}
...
function unlockApp(){
	...
	$(".lockIcon").css({'background-image':'url(https://raw.githubusercontent.com/ystanwar/Melisandre/master/static/images/unlock.png)'});
	setTimeout(function(){
		playEventSound('https://raw.githubusercontent.com/ystanwar/Melisandre/master/static/sounds/multimedia_rollover_048.mp3',$(".soundCont"));
		$(".welcomeRing1").css({'background-image':'url(https://raw.githubusercontent.com/ystanwar/Melisandre/master/static/images/welcomeRing1G.png)'});
	},500);
	setTimeout(function(){
		playEventSound('https://raw.githubusercontent.com/ystanwar/Melisandre/master/static/sounds/multimedia_rollover_048.mp3',$(".soundCont"));
		$(".welcomeRing2").css({'background-image':'url(https://raw.githubusercontent.com/ystanwar/Melisandre/master/static/images/welcomeRing2G.png)'});
	},1000);
	setTimeout(function(){
		playEventSound('https://raw.githubusercontent.com/ystanwar/Melisandre/master/static/sounds/multimedia_rollover_048.mp3',$(".soundCont1"));
		$(".welcomeRing3").css({'background-image':'url(https://raw.githubusercontent.com/ystanwar/Melisandre/master/static/images/welcomeRing3G.png)'});
